...
const siteData = {
    content: {
        ...
        staff: { 
            ...
            name: "장 용 준",
            position: "대표원장",
            titles: ["재활의학과 전문의 · 의학박사", "가톨릭대학교 재활의학교실 외래조교수"],
        ...
        values: { 
            ...
            details: [ 
                {t:"01. 융합된 전문성과<br>세계적 식견", d:"<strong>[Expertise & Global Perspective]</strong><br><br><b>Dual Specialist Insight</b><br>재활의학과 및 신경외과를 모두 전공한 의학박사(MD, PhD)의 통합적인 시각으로 질환의 근본 원인을 찾아냅니다.<br><br><b>Global Standard</b><br>북미(캐나다, 미국), 유럽(독일, 스페인), 아시아(일본) 등 세계 유수 학회와 의료 현장에서 검증된 선진 치료 시스템을 도입하여 적용합니다.<br><br><b>Dedicated Primary Physician (일관된 주치의 시스템)</b><br>우리는 다수의 의료진을 내세우지 않습니다. 검증된 실력을 갖춘 대표원장 1인이 진단부터 치료의 끝까지 전 과정을 책임집니다. 의료진 교체 없이 치료의 연속성이 보장되며, 환자 상태의 미세한 변화까지 놓치지 않는 일관되고 깊이 있는 '주치의 케어'를 제공합니다.", img:"images/values_01.webp"}, 
                {t:"02. 포괄적이고<br>근본적인 접근", d:"<strong>[Comprehensive Approach]</strong><br><br><b>Beyond Pain</b><br>눈에 보이는 통증만 쫓지 않습니다. 통증의 원인이 되는 근육, 신경, 그리고 신체 전반의 기능적 움직임까지 포괄적으로 분석하여 재발을 막는 근본 치료를 시행합니다.<br><br><b>Personalized Care</b><br>획일화된 치료가 아닌, 환자 개개인의 상태와 라이프스타일을 고려한 '최적의 맞춤 치료 계획'을 수립합니다.", img:"images/values_02.webp"}, 
                {t:"03. 타협하지 않는<br>원칙과 환경", d:"<strong>[Principles & Environment]</strong><br><br><b>Safety & Cleanliness</b><br>환자의 '안정'과 철저한 '청결'을 제1원칙으로 삼는 쾌적한 치유 공간을 제공합니다.<br><b>※3년연속 중구보건소 지정 우리동네안심병원으로 지정.</b><br><br><b>Advanced Technology</b><br>대학병원급 최신 첨단 장비를 아낌없이 투자하여 진단의 정확도와 치료 효과를 극대화합니다.<br><br><b>Transparent Policy</b><br>과잉 진료를 지양하고, 모든 치료 비용을 투명하게 공개하는 정직한 가격 정책으로 신뢰를 드립니다.", img:"images/values_03.webp"}, 
                {t:"04. 진정한 환자 중심의<br>소통과 동행", d:"<strong>[Patient-Centered Communication & Partnership]</strong><br><br><b>Clear Explanation</b><br>어려운 의학 용어가 아닌 환자의 눈높이에서, 현재 상태와 통증의 원인을 상세하고 명확하게 설명해 드립니다.<br><br><b>Shared Decision Making</b><br>일방적인 치료 결정이 아닌, 가능한 다양한 치료 옵션의 장단점을 투명하게 제공하고 환자와 함께 최선의 방법을 고민합니다.<br><br><b>Treatment Roadmap</b><br>단순히 현재의 치료를 넘어, 앞으로 나아갈 장기적인 치료 방향성과 목표를 공유하여 치료 과정의 막연한 불안감을 해소합니다.", img:"images/values_04.webp"} 
            ] 
        },
        ...
        diagnosis: { 
            ...
            details: [ 
                { t: "01. 고해상도 디지털 X-ray", d: `<strong>(High-Resolution Digital X-ray)</strong><br><br><i>\"뼈와 관절 상태를 확인하는 가장 기초적이고 필수적인 검사\"</i><br><br>기존 필름 방식 대비 방사선 피폭량을 현저히 줄여 안전성을 높인 최신 장비입니다. 촬영 즉시 고해상도의 선명한 영상을 획득하여 골절, 관절염, 척추 변형 등 골격계 이상 유무를 신속하게 평가합니다.`, img: "images/diagnosis_xray.webp" },
                { t: "02. 프리미엄 초음파 진단기 (3대)", d: `<strong>(Premium Ultrasound Systems - 3 Units)</strong><br><br><i>\"진료실에서 대기 없이 즉시 확인하는 '의사의 제2의 눈'\"</i><br><br>X-ray로 확인이 어려운 근육, 인대, 신경 등 연부 조직의 손상을 정밀하게 관찰합니다. 하이엔드급 장비 3대를 각 진료실에 배치하여, 대기 없이 진료 도중 즉각적으로 확인하고 설명해 드립니다.`, img: "images/diagnosis_ultra.webp" },
                { t: "03. C-arm (이동형 실시간 투시 영상)", d: `<strong>(C-arm Fluoroscopy with SELD)</strong><br><br><i>\"정확도는 높이고 피폭은 최소화한, 안전한 비수술 치료의 핵심\"</i><br><br>몸속을 실시간 동영상으로 보는 투시 장비입니다. 척추나 관절 깊숙한 부위에 시술 시, 바늘 위치를 네비게이션처럼 정확하게 안내합니다. 최신 저선량(SELD) 탑재로 방사선 노출을 획기적으로 줄였습니다.`, img: "images/diagnosis_carm.webp" },
                { t: "04. 신경전도 및 근전도 검사 (NCS/EMG)", d: `<strong>(Nerve Conduction & Electromyography)</strong><br><br><i>\"눈에 보이지 않는 신경과 근육의 기능적 이상을 찾아내는 정밀 검사\"</i><br><br>MRI나 X-ray만으로는 알 수 없는 신경의 기능적 상태를 전기적 신호로 평가합니다. 손발 저림, 근력 약화 등이 신경 문제인지 근육 문제인지, 손상 위치와 정도를 명확하게 감별 진단합니다.`, img: "images/diagnosis_emg.webp" }
            ] 
        },
