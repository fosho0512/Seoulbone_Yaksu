...
const siteData = {
    ...
    content: {
        ...
        treatment: { 
            ...
            slogans: [
                {
                    main: "통증을 넘어, 근본적인 기능 회복을 위한<br>통합 치료 솔루션",
            ...
            promises: [
                { title: "Strict Standard", name: "엄격한 재료의 선정", desc: "내 가족에게 쓸 수 있는 것만이 환자분에게도 허락됩니다. 우리는 임상적으로 검증된 최상의 재료만을 고집하며, 안전성과 효능에 대한 확신 없이는 절대 사용하지 않습니다." },
                { title: "Real-time Customization", name: "실시간 맞춤 처방", desc: "기계적인 루틴(Routine) 진료를 지양합니다. 매 내원 시 달라지는 신체 상태를 정밀하게 파악하여, 지금 당신에게 가장 필요한 최적의 배합으로 치료합니다." },
