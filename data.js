...
const siteData = {
    ...
    content: {
        ...
        prp: { 
            ...
            mainSlogan: "내 혈액 속 치유 성분으로<br>손상된 조직을 깨우다",
            subDesc: "환자 본인의 혈액에서 치유와 재생을 담당하는 '성장인자'만을 고농도로 농축하여, 손상된 인대·힘줄·연골 부위에 직접 주사하는 최신 재생 치료법입니다.",
            features: [
                { label: "안전성", en: "Safety", desc: "내 혈액을 사용하므로 거부 반응이나 부작용 위험이 극히 낮습니다." },
                { label: "근본 치료", en: "Fundamental", desc: "일시적 통증 완화가 아닌, 약해진 조직 자체를 튼튼하게 재생시킵니다." },
                { label: "강력한 재생", en: "Regeneration", desc: "일반 혈액보다 3~5배 농축된 성장인자가 인체의 자연 치유력을 극대화합니다." }
            ],
